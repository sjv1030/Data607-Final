...
Initially, the data will be sourced from the various sources mentioned above. Since this takes considerable time, the necessary dataframes will be saved in a SQLite database in table called "week_prices". This way every subsequent run of the `R` code will run smoothly.
